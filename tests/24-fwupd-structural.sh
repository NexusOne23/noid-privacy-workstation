...
assert_cmd_success "Silent Machine evidence rejects hidden remotes and false plugin assignments" \
    python3 "$PROJECT_ROOT/tests/fixtures/silent_update_evidence.py" "$SILENT_RUNTIME"
