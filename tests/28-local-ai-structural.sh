...
assert_grep_fixed "ollama_version=v0.33.3"          "$DOC" "current reviewed Ollama release is pinned exactly"
assert_grep_fixed "c13cea8f3389db4145f8a6cb88d1747242a48639d7c13e3bda7c1ebdc6eebb2f" "$DOC" \
...
assert_grep_fixed 'llama_cpp_build=b10867' "$DOC" \
    "current reviewed llama.cpp build is pinned exactly"
assert_grep_fixed 'llama-b10867-bin-ubuntu-vulkan-x64.tar.gz' "$DOC" \
    "reviewed Linux Vulkan artifact is named exactly"
assert_grep_fixed '5fe998ee6b06d65d80acdb036e6625ad9441d2bcd696011d9da68390959b04c1' "$DOC" \
    "reviewed llama.cpp artifact is pinned to the GitHub digest"
assert_grep_fixed '34,421,539-byte archive' "$DOC" \
    "reviewed llama.cpp artifact byte count is pinned exactly"
assert_grep_fixed 'development build 10867 at commit `f3f1a8f27`' "$DOC" \
