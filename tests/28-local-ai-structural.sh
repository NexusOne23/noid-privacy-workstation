...
assert_grep_fixed "ollama_version=v0.34.1"          "$DOC" "current reviewed Ollama release is pinned exactly"
assert_grep_fixed "f361dc3992ec07e4ad429f4bb2d10d4663ba2c295f9a9a688c7d52f4ba650034" "$DOC" \
    "current reviewed Ollama artifact is pinned independently"
assert_grep_fixed 'probe reported 0.34.1' "$DOC" \
...
assert_grep_fixed 'llama_cpp_build=b11010' "$DOC" \
    "current reviewed llama.cpp build is pinned exactly"
assert_grep_fixed 'llama-b11010-bin-ubuntu-vulkan-x64.tar.gz' "$DOC" \
    "reviewed Linux Vulkan artifact is named exactly"
assert_grep_fixed '80b6cf394149e888e6d8f363cb0777d12a423a0da6cf0247e678fd4cc3ab13f4' "$DOC" \
    "reviewed llama.cpp artifact is pinned to the GitHub digest"
assert_grep_fixed '30,218,634-byte archive' "$DOC" \
    "reviewed llama.cpp artifact byte count is pinned exactly"
assert_grep_fixed 'development build 11010 at commit `4bc272fd7`' "$DOC" \
...
assert_grep_fixed 'llama_vscode_version=0.0.64' "$DOC" \
    "llama-vscode package version is pinned to the reviewed Open VSX release"
assert_grep_fixed '0b14816ab43665e1fbc23be0f2aa61ae1171aab970405e65e702f64020592fec' "$DOC" \
...
assert_grep_fixed 'without either ignore check or a workspace-boundary check' "$DOC" \
    "llama-vscode 0.0.64 incremental RAG defect is explicit"
