...
exercise_heredoc_generator liveinst-webui-lifecycle \
    "$ROOT/scripts/regen-liveinst-webui-lifecycle-embed.sh" \
    "$ROOT/scripts/noid-liveinst-webui-lifecycle.py" \
    "$ROOT/kickstart/snippets/17-gnome-hardening.ks" \
    NOID_LIVEINST_LIFECYCLE_SOURCE NOID_LIVEINST_LIFECYCLE_M17 \
    NOID_LIVEINST_WEBUI_LIFECYCLE_EOF '# generator fixture'
exercise_heredoc_generator lid-action \
    "$ROOT/scripts/regen-lid-action-embed.sh" \
    "$ROOT/scripts/noid-toggle-lid-action.sh" \
    "$ROOT/kickstart/snippets/17-gnome-hardening.ks" \
    NOID_LID_SOURCE NOID_LID_M17 NOID_LID_ACTION_EOF '# generator fixture'
