...
assert_grep_fixed 'CLAUDE_VERSION="2.1.278"' "$CLAUDE_INSTALLER" \
    "Claude native seed matches the reviewed vendor release"
assert_grep_fixed 'CLAUDE_SHA256="5c4735937844e84f8a93306e841a5b0e12252909b07870f789b190468da147ab"' \
    "$CLAUDE_INSTALLER" \
    "Claude 2.1.278 native seed is bound to the reviewed vendor bytes"
assert_grep_fixed 'CLAUDE_SIZE="234119480"' "$CLAUDE_INSTALLER" \
    "Claude 2.1.278 native seed is bound to the reviewed byte count"
...
assert_grep_fixed 'EXT_VERSION="2.1.278"' "$CLAUDE_INSTALLER" \
    "Claude VSCodium seed matches the reviewed fixed client release"
assert_grep_fixed 'EXT_SHA256="12e1de8156325bcf8845c2ab6cc996ff1c3a536d3cf325fede3ff914e3fb7845"' \
    "$CLAUDE_INSTALLER" \
    "Claude 2.1.278 VSIX seed is bound to the reviewed Open VSX bytes"
assert_grep_fixed 'EXT_SIZE="108048809"' "$CLAUDE_INSTALLER" \
    "Claude 2.1.278 VSIX seed is bound to the reviewed byte count"
...
assert_grep_fixed 'CODEX_VERSION="0.155.1"' "$CODEX_INSTALLER" \
    "Codex standalone seed matches the reviewed stable release"
assert_grep_fixed 'CODEX_SHA256="a65b895c6ac1a73629bbe4b864640c86133e94a43b4d67b3103044e1a306d5a2"' \
    "$CODEX_INSTALLER" \
    "Codex 0.155.1 standalone seed matches the official release digest"
assert_grep_fixed 'CODEX_SIZE="138838055"' "$CODEX_INSTALLER" \
    "Codex 0.155.1 standalone seed is bound to the reviewed byte count"
assert_grep_extended '^CODEX_SHA256="[0-9a-f]{64}"$' "$CODEX_INSTALLER" \
    "Codex installer pins standalone SHA256"
assert_grep_fixed 'EXT_VERSION="26.5908.31748"' "$CODEX_INSTALLER" \
    "Codex VSCodium seed matches the reviewed Open VSX release"
assert_grep_fixed 'EXT_SHA256="7a359b93b200e4406eb19858a48fa7e2da6ed557d3579ad8ec6b63ee4d354b45"' \
    "$CODEX_INSTALLER" \
    "Codex VSCodium seed matches the Open VSX published digest"
assert_grep_fixed 'EXT_SIZE="249969698"' "$CODEX_INSTALLER" \
