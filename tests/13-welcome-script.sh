...
assert_grep_fixed 'CLAUDE_VERSION="2.1.267"' "$CLAUDE_INSTALLER" \
    "Claude native seed matches the reviewed vendor release"
assert_grep_fixed 'CLAUDE_SHA256="0399c793ff571d5946ef923d80b4f330d05ac4b6842a6b0775468f5d389403c0"' \
    "$CLAUDE_INSTALLER" \
    "Claude 2.1.267 native seed is bound to the reviewed vendor bytes"
assert_grep_fixed 'CLAUDE_SIZE="217013744"' "$CLAUDE_INSTALLER" \
    "Claude 2.1.267 native seed is bound to the reviewed byte count"
...
assert_grep_fixed 'EXT_VERSION="2.1.267"' "$CLAUDE_INSTALLER" \
    "Claude VSCodium seed matches the reviewed fixed client release"
assert_grep_fixed 'EXT_SHA256="b3ab8c245d50f5b605bea2ca45eaea6532fb5738c56aff81cc8f4f9044ed8fdd"' \
    "$CLAUDE_INSTALLER" \
    "Claude 2.1.267 VSIX seed is bound to the reviewed Open VSX bytes"
assert_grep_fixed 'EXT_SIZE="101307826"' "$CLAUDE_INSTALLER" \
    "Claude 2.1.267 VSIX seed is bound to the reviewed byte count"
...
assert_grep_fixed 'CODEX_VERSION="0.154.0"' "$CODEX_INSTALLER" \
    "Codex standalone seed matches the reviewed stable release"
assert_grep_fixed 'CODEX_SHA256="fc6e3e3b85f2cf7d664520ee5c66a7fe4aa12bae7d46834f47e2f165fd0d6f78"' \
    "$CODEX_INSTALLER" \
    "Codex 0.154.0 standalone seed matches the official release digest"
assert_grep_fixed 'CODEX_SIZE="126585776"' "$CODEX_INSTALLER" \
    "Codex 0.154.0 standalone seed is bound to the reviewed byte count"
