...
| Version | Supported |
|---------|-----------|
| `main` (v1.8 release line) | :white_check_mark: (active maintained line) |
| v1.8 | :white_check_mark: (current Fedora 44 release line) |
| v1.7 and older | :x: (upgrade to the supported line) |

Support is scoped to the v1.8/Fedora 44 release and the `main` release line
