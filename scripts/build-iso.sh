...
stage_reduced_dependency_cache() {
    ...
    local expected_sha="5b74415860456370644bd80f16125e865b0e6c356bb5dfcfb84069967eaa5287"
    local expected_size=4650100
...
stage_noid_audit() {
    ...
    local source_commit="8fe9efe585b49687ce2dde9ac515c56959128b5b"
