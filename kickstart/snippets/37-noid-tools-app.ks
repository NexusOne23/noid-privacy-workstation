...
# Status: LOCKED 2026-09-02 (v34) — describe the Intel ME lockdown row as the core-module lockdown it controls.
#
    ...
    ('Encryption &amp; Recovery',
     ...
     [
         ...
         ('🗝️', 'GRUB Password',
          ...
          [('Set', []), ('Remove', ['--remove'])]),
         ('⚙️', 'Intel ME Lockdown',
          'Shows the Intel Management Engine core-module lockdown state; '
