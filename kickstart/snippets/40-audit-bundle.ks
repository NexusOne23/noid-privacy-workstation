...
# Status: LOCKED 2026-09-22 (v49) — pin the re-published v3.7.2 release commit; the audit bytes are unchanged.
#
...
NOID_AUDIT_COMMIT="8fe9efe585b49687ce2dde9ac515c56959128b5b"
NOID_AUDIT_SIZE="639310"
NOID_AUDIT_SHA256="30ce5f49a8d119a8801620c342e146da087210d68aa920d06083571f05d7546c"
...
readonly SCRIPT_SIZE="639310"
readonly SCRIPT_SHA256="30ce5f49a8d119a8801620c342e146da087210d68aa920d06083571f05d7546c"
...
trusted_root_dir() {
    local path=$1 metadata=$2 current=/ remaining component actual mode
    [[ "$path" == /* ]] || return 1
    remaining=${path#/}
    # Validate each ancestor before looking up its child: a protected final
    # directory does not prevent replacement through a writable ancestor.
    while :; do
        [ -d "$current" ] && [ ! -L "$current" ] || return 1
        actual=$("$STAT" -Lc '%u:%g:%a' -- "$current" 2>/dev/null) || return 1
