...
# Status: LOCKED 2026-09-17 (v85) — publish Module 21's 52 deny and 44 absent identities after the appletalk retirement.
#
# Ships:
...
- **21 kernel-module-policy** — 134 normalized identities: 52 canonical
  ...
  44 absent identities, 2 historical aliases and 28 supported modules are
...
| Kernel exploits | Mitigated | 106 static sysctl assignments + one generated durable assignment for the selected physical interface and event-time enforcement on every physical pre-up + a 134-state module inventory with 53 effective loadable-module denies + 50 shared kernel-command-line tokens (+ up to 7 hardware-conditional) plus one LUKS unlock-retry token per encrypted volume; built-ins and kernel zero-days remain residual risk |
...
**Package and standards evidence last verified**: 2026-09-02. The observed
Fedora 44 environment used OpenSSH 10.2p1, OpenSSL 3.5.7, OpenVPN 2.7.6,
Firefox 154, Thunderbird 153, NSS 3.126, and GnuPG 2.4.9. This dated snapshot
supports the assessment below but is not an exact v1.8 ISO package manifest;
...
derivative, XDP BPF source/object, Firefox derivative, upstream license
texts, documentation and branding assets listed below. No upstream source
tree is vendored into this repository.
...
`tests/smoke/README.md`, `scripts/anaconda-patch/README.md`,
