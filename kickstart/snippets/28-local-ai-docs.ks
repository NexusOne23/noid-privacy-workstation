...
# Status: LOCKED 2026-09-08 (v43) — advance the reviewed llama.cpp evaluation pin to b10867.
#
...
At the 2026-09-06 review, Fedora 44 still offered `ollama-0.12.11-4.fc44`.
...
2026-09-06 review, the current upstream release was `v0.33.3`; its published
Linux x86-64 artifact was 1,433,825,108 bytes, and the vendor checksum plus
...
ollama_expected=c13cea8f3389db4145f8a6cb88d1747242a48639d7c13e3bda7c1ebdc6eebb2f
...
For v0.33.3 the vendor checksum matched the retained pin, the archive had no
...
0.33.3, and `ollama serve --help` retained the loopback default plus the
...
2025-05-27, release `v0.8.0` contains that commit, and the reviewed `v0.33.3`
...
issue 17042 links the repair to merged commit `67b6a1c2d453`; `v0.33.3`
...
blob redirects. The reviewed `v0.33.3` source still returns a cross-host
...
At the 2026-09-08 review, the newest upstream `b*` release carrying the
documented Ubuntu x86-64 Vulkan artifact was development build `b10867`.
This is the continuous pre-release channel; the stable `v0.4.0` release did
not publish that binary artifact. Its exact
34,421,539-byte archive and the GitHub release metadata both
resolved to SHA-256
`5fe998ee6b06d65d80acdb036e6625ad9441d2bcd696011d9da68390959b04c1`.
...
(
set -euo pipefail
llama_cpp_build=b10867
llama_cpp_asset=llama-b10867-bin-ubuntu-vulkan-x64.tar.gz
llama_cpp_expected=5fe998ee6b06d65d80acdb036e6625ad9441d2bcd696011d9da68390959b04c1
...
The downloaded b10867 binary was also executed offline in a network-unshared
sandbox for `--version`, `--help` and `--list-devices`; the binary identified
development build 10867 at commit `f3f1a8f27`. The documented
