...
# Status: LOCKED 2026-09-02 (v50) — cite the real systemd.link WakeOnLan= version floor.
#
# Covers:
...
# (systemd.link WakeOnLan= since v211; F44 ships v259), applied by systemd-udevd during link setup
