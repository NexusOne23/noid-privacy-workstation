...
| [`08-service-minimization.ks`](kickstart/snippets/08-service-minimization.ks) | Service masks/drop-ins, privacy toggles, AI-agent configuration and VSCodium/Claude integration; the optional native Claude/Codex installers themselves are shipped by M13. |
