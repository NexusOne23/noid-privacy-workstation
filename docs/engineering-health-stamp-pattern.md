...
Boundary: `noid-status` (M13) does not read these stamps at runtime. They
are compose-time evidence consumed by the finalizer and its structural
tests, not an installed-system health display.
