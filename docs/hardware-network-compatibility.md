...
Hardware not exercised by that matrix must not be advertised as individually
validated. The runtime gates still apply, including the explicitly degraded
fallback when the complete XDP/TC contract cannot be met.
